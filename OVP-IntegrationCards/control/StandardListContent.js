...
sap.ui.define([
	...
	function (library, BaseContent, sapMList, StandardListItem, ManagedObject, IconFormatter, BindingHelper) {
		 ...
		 */
		var ListContent = BaseContent.extend("vistex.poc.ovp.control.StandardListContent", {
			renderer: {}
		});
...
//			this._oItemTemplate = new StandardListItem(mSettings).addStyleClass("borderBottom");
			this._oItemTemplate = sap.ui.xmlfragment("vistex.poc.ovp.fragments.ObjectList", this);
		...
		ListContent.prototype._setStaticItems = function (mItems) {
			...
			mItems.forEach(function (oItem) {
				...
				oListItem = sap.ui.xmlfragment("vistex.poc.ovp.fragments.StandardList", this);
